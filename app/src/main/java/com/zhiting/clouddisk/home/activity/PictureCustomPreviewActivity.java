 ...
 * @描述: 预览图片
 */
public class PictureCustomPreviewActivity extends PictureBaseActivity implements View.OnClickListener {
    ...
    public int getResourceId() {
        return R.layout.activity_external_preview;
    }

    @Override
    protected void initWidgets() {
        super.initWidgets();
        mTitleBar = findViewById(com.luck.picture.lib.R.id.titleBar);
        tvTitle = findViewById(com.luck.picture.lib.R.id.picture_title);
        ibLeftBack = findViewById(com.luck.picture.lib.R.id.left_back);
        ibDelete = findViewById(com.luck.picture.lib.R.id.ib_delete);
        viewPager = findViewById(com.luck.picture.lib.R.id.preview_pager);
        ...
        if (mediaList != null && mediaList.size() > 0) {
            for (LocalMedia localMedia : mediaList) {
                ...
                path = path.replace("api/wangpan/api", "wangpan/api");
    ...
    public void setTitle(int position) {
        tvTitle.setText(images.get(position).getFileName());
    }
...
//            boolean isGif = PictureMimeType.isGif(mimeType);
            boolean isGif = isGif(media.getPath());
                ...
                longImageView.setOnLongClickListener(v -> {
                    if (config.isNotPreviewDownload) {
                        if (PermissionChecker.checkSelfPermission(getContext(), Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                            ...
                            PermissionChecker.requestPermissions(PictureCustomPreviewActivity.this,
    ...
    public boolean isGif(String path) {
        return path != null && (path.toLowerCase().contains("gif"));
    }
    ...
    private void onSuccessful(String filePath) {
        if (TextUtils.isEmpty(filePath)) {
            ToastUtils.s(getContext(), getString(com.luck.picture.lib.R.string.picture_save_error));
        } else {
            new PictureMediaScannerConnection(getContext(), filePath, null);
            ToastUtils.s(getContext(), getString(com.luck.picture.lib.R.string.picture_save_success) + "\n" + filePath);
        }
    }
    ...
    private void exitAnimation() {
        overridePendingTransition(com.luck.picture.lib.R.anim.picture_anim_fade_in, PictureSelectionConfig.windowAnimationStyle.activityPreviewExitAnimation);
    }
        ...
        if (requestCode == PictureConfig.APPLY_STORAGE_PERMISSIONS_CODE) {// 存储权限
            for (int grantResult : grantResults) {
                if (grantResult == PackageManager.PERMISSION_GRANTED) {
                    ...
                    ToastUtils.s(getContext(), getString(com.luck.picture.lib.R.string.picture_jurisdiction));
                }
            }
        }
    }
