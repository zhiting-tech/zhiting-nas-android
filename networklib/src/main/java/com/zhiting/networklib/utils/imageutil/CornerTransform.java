...
public class CornerTransform implements Transformation<Bitmap> {
    ...
    public static final int RIGHT_TOP_CORNER = 2;
    public static final int RIGHT_BOTTOM_CORNER = 3;
    public static final int LEFT_BOTTOM_CORNER = 4;
    public static final int ALL_CORNER = 5;
    ...
    public void setLeftTopCorner(){
        setExceptCorner(false,true,true,true);
    }

    public void setRightTopCorner(){
        setExceptCorner(true,false,true,true);
    }

    public void setRightBottomCorner(){
        setExceptCorner(true,true,true,false);
    }

    public void setLeftBottomCorner(){
        setExceptCorner(true,true,false,true);
    }

    public CornerTransform(Context context, float radius) {
        this(context,radius,ALL_CORNER);
    }

    public CornerTransform(Context context,float radius,int cornerType){
